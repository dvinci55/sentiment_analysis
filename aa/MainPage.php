...
document.getElementById("loader").style.display = "block";
    ...
    <div class="container">
        <div class="card card-container">
            ...
            <form class="form-signin" action="Sentiphp.php" method="post">
                ...
                <button class="btn btn-lg btn-primary btn-block btn-signin" type="submit">Apply Sentimental Analysis</button>
          
</form><!-- /form -->
           <table align="center" width="500px" height="400px" style="font-size:14px;color:#000">
		<?php		
