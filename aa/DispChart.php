...
<?php 
$file=fopen("count.txt","r") or die(" unalble to open");
$home=fread($file,filesize("count.txt"));
$home= explode(",", $home);
$a=$home[0];
$b=$home[1];
...
if($a>$b)
{
	$result="This Product is Good..";
}
else
{
	$result="This Product is Not Worth to Buy";
}
?>
<center>
Conclusion of the Product is:<input type="text" value="<?php echo $result;?>" style="font-size:14px;color:red"width="auto"/></center>
<center>
		<img src="image.png" alt="Smiley face" height="50%" width="50%"></img>
		</center>
