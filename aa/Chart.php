...
document.getElementById("loader").style.display = "block";
    ...
    <div class="container">
        <div class="card card-container">
            ...
            <form class="form-signin" action="Graphphp.php" method="post">
                ...
                <button class="btn btn-lg btn-primary btn-block btn-signin" type="submit">Generate Graph</button>
          
</form><!-- /form -->
        <h1>Positive Reviews</h1>
                <table align="left" width="auto" height="auto" style="font-size:14px;color:#000">
		<?php		
		$f = fopen("pos.txt", "r");
		...
		$count=$count+1;
		 ...
		 echo "<td>" . "<ul>
    <li>".htmlspecialchars($cell) . "</li></ul></td>";
		...
		<h1 align="left">Negative Reviews</h1>
		   <table align="left" width="auto" height="auto" style="font-size:14px;color:#000">
		<?php		
		$ff = fopen("neg.txt", "r");


		while (($line = fgetcsv($ff)) !== false) {
        	echo "<tr>";
